...
/**
          ...
          */
var n=e("precedent"),i=function(){function e(t){_classCallCheck2(this,e),this.templateProcessor=new n,this.templateProcessor.addPattern("${","}",(function(e){var t=e.trim(),n=t.indexOf("|"),i=t.substring(n+1),o=n>-1?t.substring(0,n):t;return r.env.hasOwnProperty(o)?r.env[o]:i}))}return _createClass2(e,[{key:"parseSetting",value:function(e){return this.templateProcessor.parseString(e)}}]),e}();t.exports=i}).call(this)}).call(this,e("_process"))},{_process:44,precedent:41}],33:[function(e,t,r){
/**
