...
*/
var n=e("async"),i=function(){function e(){_classCallCheck2(this,e)}return _createClass2(e,[{key:"newParserState",value:function(e){return{ParseTree:e,Asynchronous:!1,Output:"",OutputBuffer:"",Pattern:!1,PatternMatch:!1,PatternMatchOutputBuffer:""}}},{key:"assignNode",value:function(e,t){t.PatternMatch=e,t.PatternMatch.hasOwnProperty("PatternEnd")&&(t.Pattern=t.PatternMatch)}},{key:"appendOutputBuffer",value:function(e,t){t.OutputBuffer+=e}},{key:"flushOutputBuffer",value:function(e){e.Output+=e.OutputBuffer,e.OutputBuffer=""}},{key:"checkPatternEnd",value:function(e,t){e.OutputBuffer.length>=e.Pattern.PatternEnd.length+e.Pattern.PatternStart.length&&e.OutputBuffer.substr(-e.Pattern.PatternEnd.length)===e.Pattern.PatternEnd&&(e.Pattern.isAsync?(console.log("ERROR: Async template detected for pattern ".concat(e.Pattern.PatternStart," ... ").concat(e.Pattern.PatternEnd," but the template engine is being run in non-async mode.")),this.OutputBuffer="",this.flushOutputBuffer(e),e.Pattern=!1,e.PatternMatch=!1):(e.OutputBuffer=e.Pattern.Parse(e.OutputBuffer.substr(e.Pattern.PatternStart.length,e.OutputBuffer.length-(e.Pattern.PatternStart.length+e.Pattern.PatternEnd.length)),t),this.flushOutputBuffer(e),e.Pattern=!1,e.PatternMatch=!1))}},{key:"checkPatternEndAsync",value:function(e,t,r){var n=this;if(e.OutputBuffer.length>=e.Pattern.PatternEnd.length+e.Pattern.PatternStart.length&&e.OutputBuffer.substr(-e.Pattern.PatternEnd.length)===e.Pattern.PatternEnd){if(e.Pattern.isAsync)return e.Pattern.Parse(e.OutputBuffer.substr(e.Pattern.PatternStart.length,e.OutputBuffer.length-(e.Pattern.PatternStart.length+e.Pattern.PatternEnd.length)),t,(function(t,i){return t?r(t):(e.OutputBuffer=i,n.flushOutputBuffer(e),e.Pattern=!1,e.PatternMatch=!1,r())}));e.OutputBuffer=e.Pattern.Parse(e.OutputBuffer.substr(e.Pattern.PatternStart.length,e.OutputBuffer.length-(e.Pattern.PatternStart.length+e.Pattern.PatternEnd.length)),t),this.flushOutputBuffer(e),e.Pattern=!1,e.PatternMatch=!1}return r()}},{key:"parseCharacter",value:function(e,t,r){!t.PatternMatch&&t.ParseTree.hasOwnProperty(e)?(this.assignNode(t.ParseTree[e],t),this.appendOutputBuffer(e,t)):t.PatternMatch?(t.PatternMatch.hasOwnProperty(e)&&this.assignNode(t.PatternMatch[e],t),this.appendOutputBuffer(e,t),t.Pattern&&this.checkPatternEnd(t,r)):t.Output+=e}},{key:"parseCharacterAsync",value:function(e,t,r,n){if(!t.PatternMatch&&t.ParseTree.hasOwnProperty(e))this.assignNode(t.ParseTree[e],t),this.appendOutputBuffer(e,t);else if(t.PatternMatch){if(t.PatternMatch.hasOwnProperty(e)&&this.assignNode(t.PatternMatch[e],t),this.appendOutputBuffer(e,t),t.Pattern)return this.checkPatternEndAsync(t,r,n)}else t.Output+=e;return n(null)}},{key:"parseString",value:function(e,t,r,i){var o=this;if("function"!=typeof i){for(var a=this.newParserState(t),s=0;s<e.length;s++)this.parseCharacter(e[s],a,r,i);return this.flushOutputBuffer(a),a.Output}var u=this.newParserState(t);n.eachSeries(e,(function(e,t){o.parseCharacterAsync(e,u,r,t)}),(function(e){o.flushOutputBuffer(u),i(e,u.Output)}))}}]),e}();t.exports=i},{async:16}],57:[function(e,t,r){
/**
* Word Tree
*
* @license     MIT
