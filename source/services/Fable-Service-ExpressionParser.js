...
class FableServiceExpressionParser extends libFableServiceBase
{
	...
	recompose(pTokens)
	{
		return this.Tokenizer.recompose(pTokens);
	}
	 ...
	 */
	addSolverFunction(pFunctionName, pFunctionAddress, pFunctionComment, pAddressParameterIndices)
	{
		...
		this.functionMap[tmpFunctionName] = tmpFunctionEntry;
	}
